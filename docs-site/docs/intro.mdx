...
slug: /
sidebar_position: 0
title: Welcome to WebBank
---

# Welcome to the WebBank Tutorial

Learn how to build **accessible Flutter web apps** by creating a real banking dashboard.

## What You'll Build

WebBank is a responsive banking dashboard featuring:
...
```mermaid
graph LR
    A["Ch 0: Toolkit"] --> B["Ch 1: Hello WebBank"]
    B --> C["Ch 2: Responsive"]
    C --> D["Ch 3: Routing"]
    D --> E["Ch 4: Semantics"]
    E --> F["Ch 5: Keyboard"]
...
```bash
git clone https://github.com/team360r/WebBank.git
cd WebBank
./setup.sh
./start.sh
```
